        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo site_url(); ?>"><span class="glyphicon glyphicon-home"></span> PEMIRA</a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        <li class='dropdown'><a href='#' class='dropdown-toggle' data-toggle='dropdown'><span class="glyphicon glyphicon-user"></span> Welcome, <?php echo $itemuser->first_name;?> <b class='caret'></b></a>
                    		<ul class='dropdown-menu'>
                                <li><a href="<?php echo site_url('admin/dashboard/profil')?>">Profil</a></li>
                                <li><a href="<?php echo site_url('admin/dashboard/ubahpassword')?>">Ubah Password</a></li>
